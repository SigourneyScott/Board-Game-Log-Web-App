import { Events, shadow, html, css } from "@calpoly/mustang";

export class PlayerInputArrayElement extends HTMLElement {
    ...
    constructor() {
        super();
        shadow(this)
            .template(PlayerInputArrayElement.template)
            .styles(PlayerInputArrayElement.styles);
...
export { PlayerInputArrayElement as Element };
